...
steamid64   = 76561197996678278   # <-- 玩家的64位steamid


# Path to the folder where CSVs should be saved
output_folder = r"C:\\Users\\14799\\Desktop\\scouting\\teses_dust2" # <-- demo文件夹

# Make sure output folder exists
os.makedirs(output_folder, exist_ok=True)

# demo
folder = r"C:\\Users\\14799\\Desktop\\demos\\teses_dust2" # <-- 输出文件夹
